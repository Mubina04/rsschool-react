...
import {tHeaders, tBodys, tFoots} from './product_data';
import {homeStyles} from '@/styles';
import {getRates} from '@/api/getrates';
import { useTranslation } from 'react-i18next';

const Product: FC<{ res?: any }> = ({res}) => {
		...
		<div className='container py-20'>
			<div>
				<div className='my-14'>
					...
					<h2 className={`${homeStyles.section_heading} mt-6`}>{t("HOME.TARIFFS.TARIFF_TYPE_2")}</h2>
				</div>
