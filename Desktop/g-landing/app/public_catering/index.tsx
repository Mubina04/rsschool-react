...
import {tHeaders, tBodys, tFoots} from './public_data';
import {Table} from '@/components';
import {getRates} from '@/api/getrates';
import { useTranslation } from 'react-i18next';

const PublicCatering: FC<{ res?: any }> = ({res}) => {
	...
	return (
		...
		<div>
			<div className='my-14'>
				...
				<h2 className={`${homeStyles.section_heading} mt-6`}>{t("HOME.TARIFFS.TARIFF_TYPE_4")}</h2>
			</div>
