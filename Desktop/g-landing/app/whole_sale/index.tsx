...
import {tHeaders, tBodys, tFoots} from './sale_data';
import {Table} from '@/components';
import {getRates} from '@/api/getrates';
import { useTranslation } from 'react-i18next';

const WholeSale: FC<{ res?: any }> = ({res}) => {
		...
		<div className='container py-20'>
			<div>
				<div className='my-14'>
					...
					<h2 className={`${homeStyles.section_heading} mt-6`}>{t("HOME.TARIFFS.TARIFF_TYPE_3")}</h2>
				</div>
